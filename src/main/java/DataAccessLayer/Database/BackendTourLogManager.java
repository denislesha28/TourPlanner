...
public class BackendTourLogManager {
    ...
    public void updateTourLog(String timestamp,TourLog tourLog) throws TourLogDatabaseOperationException {
    ...
    public void updateTourLogVector(String timestamp,TourLog tourLog) throws TourLogDatabaseOperationException {
        String updateSql = "update \"TourPlanner\".\"tourLog\"\n" +
